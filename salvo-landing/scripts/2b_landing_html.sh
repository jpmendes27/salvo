...
<body>
                    ...
                    <div class="phone__screen">
                        <div class="whatsapp__chat">
                            <div class="chat__message chat__message--received">
                                <p>Olá! Estou procurando uma pizzaria próxima 🍕</p>
                            </div>
                            <div class="chat__message chat__message--sent">
                                <p>Encontrei 3 pizzarias próximas a você! 📍</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="steps">
                        <div class="step">
                            ...
                            <div class="step__content">
                                ...
                                <p>Mande no WhatsApp o que você está procurando</p>
                            </div>
                        </div>
                        <div class="step">
                            <div class="step__number">2</div>
                            <div class="step__content">
                                <h3>Compartilhe sua localização</h3>
                                <p>Envie sua localização para encontrarmos opções próximas</p>
                            </div>
                        </div>
                        <div class="step">
                            <div class="step__number">3</div>
                            <div class="step__content">
                                <h3>Receba sugestões</h3>
                                <p>Veja os 3 negócios mais próximos e entre em contato direto</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="steps">
                        <div class="step">
                            ...
                            <div class="step__content">
                                ...
                                <p>Informe dados básicos e localização do seu estabelecimento</p>
                            </div>
                        </div>
                        <div class="step">
                            <div class="step__number">2</div>
                            <div class="step__content">
                                <h3>Apareça para clientes</h3>
                                <p>Seja encontrado por pessoas que procuram seus produtos/serviços</p>
                            </div>
                        </div>
                        <div class="step">
                            <div class="step__number">3</div>
                            <div class="step__content">
                                <h3>Receba contatos diretos</h3>
                                <p>Clientes interessados entram em contato pelo seu WhatsApp</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section class="benefits section" id="beneficios">
        <div class="container">
            <h2 class="section__title">Por que escolher o Salvô?</h2>
            <div class="benefits__grid">
                <div class="benefit">
                    <div class="benefit__icon">💰</div>
                    <h3>100% Gratuito</h3>
                    <p>Sem taxas, sem mensalidades. Sempre gratuito para todos.</p>
                </div>
                <div class="benefit">
                    <div class="benefit__icon">📱</div>
                    <h3>Direto no WhatsApp</h3>
                    <p>Use o app que você já conhece. Sem downloads extras.</p>
                </div>
                <div class="benefit">
                    <div class="benefit__icon">📍</div>
                    <h3>Localização Inteligente</h3>
                    <p>Encontre ou seja encontrado por pessoas próximas a você.</p>
                </div>
                <div class="benefit">
                    <div class="benefit__icon">⚡</div>
                    <h3>Rápido e Simples</h3>
                    <p>Cadastro em minutos, resultados na hora.</p>
                </div>
                <div class="benefit">
                    <div class="benefit__icon">🛡️</div>
                    <h3>Seguro e Confiável</h3>
                    <p>Seus dados protegidos e conversas privadas.</p>
                </div>
                <div class="benefit">
                    <div class="benefit__icon">🚀</div>
                    <h3>Aumente suas Vendas</h3>
                    <p>Seja descoberto por novos clientes da sua região.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="testimonials section">
        <div class="container">
            <h2 class="section__title">O que nossos usuários dizem</h2>
            <div class="testimonials__grid">
                <div class="testimonial">
                    <div class="testimonial__content">
                        <p>"Incrível! Em 2 dias já recebi 5 novos clientes através do Salvô. Super recomendo!"</p>
                    </div>
                    <div class="testimonial__author">
                        <div class="testimonial__avatar">M</div>
                        <div>
                            <h4>Maria Silva</h4>
                            <span>Dona da Pizzaria da Maria</span>
                        </div>
                    </div>
                </div>
                <div class="testimonial">
                    <div class="testimonial__content">
                        <p>"Precisava de um eletricista urgente e o Salvô me conectou com um profissional em 5 minutos!"</p>
                    </div>
                    <div class="testimonial__author">
                ...
                <div class="testimonial">
                    <div class="testimonial__content">
                        <p>"Simples, rápido e eficiente. Exatamente o que meu salão precisava para crescer!"</p>
                    </div>
                    <div class="testimonial__author">
                        <div class="testimonial__avatar">A</div>
                        <div>
                            <h4>Ana Costa</h4>
                            <span>Salão de Beleza Ana</span>
                        </div>
                    </div>
                </div>
            </div>
