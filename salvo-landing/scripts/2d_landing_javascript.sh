...
# Script 2d: JavaScript da Landing Page do Salvô
# Autor: Rafael Ferreira
# Data: 2025-08-09

echo "⚡ Criando JavaScript da Landing Page..."

# Criar arquivo JavaScript principal
echo "📄 Criando app.js..."
cat > salvo-landing/assets/js/app.js << 'EOF'
...
echo ""
echo "✅ JavaScript da Landing Page criado com sucesso!"
echo ""
echo "⚡ Funcionalidades implementadas:"
echo "   ├── 📱 Navegação responsiva com menu mobile"
echo "   ├── 🎯 Modal de formulários (PF/PJ)"
echo "   ├── ✅ Validação completa de campos"
echo "   ├── 🎭 Máscaras para WhatsApp e CNPJ"
echo "   ├── 🔗 Smooth scroll para navegação"
echo "   ├── 📊 Tracking UTM automático"
echo "   ├── 🎨 Tabs interativas (Como funciona)"
echo "   ├── ❓ FAQ accordion"
echo "   ├── 🛡️ Integração reCAPTCHA v3"
echo "   └── 🔥 Envio para Firebase"
echo ""
echo "🔧 Validações incluídas:"
echo "   ├── Nome completo (mín. 2 caracteres)"
echo "   ├── WhatsApp (formato brasileiro)"
echo "   ├── E-mail (regex RFC compliant)"
echo "   ├── CNPJ (algoritmo oficial)"
echo "   ├── Cidade/UF obrigatórios"
echo "   └── Aceite LGPD obrigatório"
echo ""
echo "🎯 Próximo passo:"
echo "   Execute: chmod +x 2e_landing_deploy.sh && ./2e_landing_deploy.sh"
echo ""
echo "✨ JavaScript completo e funcional!"